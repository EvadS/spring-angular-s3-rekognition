...
import com.se.sample.errors.exception.IncorrectImageException;
...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex, WebRequest request) {
        ...
        return buildErrorResponse(ex, "Incorrect image request", ex.getMessage(), HttpStatus.BAD_REQUEST, request);
    }
